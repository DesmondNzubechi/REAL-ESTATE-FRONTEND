                    ...
                    return <div key={index} className="border">
                        ...
                        <div className="flex flex-col gap-[20px] px-[20px] py-[20px] ">
                            ...
                            <div className="flex items-center gap-3 justify-between">
                                <div className="flex items-center text-textColor gap-1"><h1 className="font-bold md:text-[20px] text-[10px] ">{property.bedroom}</h1>< MdBedroomParent className="md:text-[20px] text-[10px] "/> <p>Bedroom</p></div>
                                <div className="flex items-center text-textColor gap-1"><h1 className="font-bold md:text-[20px] text-[10px] ">{property.bathroom}</h1>< MdBathtub className="md:text-[20px] text-[10px] "/> <p>Bathroom</p></div>
                                <div className="flex items-center text-textColor justify-center gap-1 "><h1 className="font-bold md:text-[20px] text-[10px] ">{property.car}</h1>< GiHomeGarage className="md:text-[20px] text-[10px] "/> <p>Carpark</p></div>
                            </div>
                        </div>
                    </div>
                })
