...
<div className='flex flex-col gap-5 justify-center mb-[50px] items-center text-center'>
        ...
        <div className="grid grid-cols-1 text-center gap-[70px] md:grid-cols-2 lg:grid-cols-3">
                <div className="flex flex-col py-[50px] gap-[30px]  p-[20px] shadow-2xl items-center">
                    ...
                    <h1 className="md:text-[20px] text-[15px]  font-bold  text-textTitle">Desmon Nzubechukwu</h1>
                    </div>
<p className="text-textColor text-[12px] md:text-[15px]  ">When you land on a sample web page or open an email template and see content beginning with "lorem ipsum," the page creator placed that apparent gibberish there on purpose.</p>
                </div>
