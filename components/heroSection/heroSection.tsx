...
useEffect(() => {
    ...
    return (
        <>
            ...
            <div className="relative max-w-[700px] text-light text-center z-[100] px-[30px] pt-[100px] pb-[100px] md:py-[100px]  lg:py-[130px] flex flex-col gap-[30px] justify-center items-center min-h-[100vh] md:min-h-[50vh] lg:min-h-[100vh]">
