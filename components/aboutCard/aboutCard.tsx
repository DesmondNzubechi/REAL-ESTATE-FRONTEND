...
<Image src={house1} alt='property' className='' />
            ...
            <div className='flex flex-col gap-[30px] max-w-[600px] '>
                ...
                <h1 className='font-bold text-[30px] text-textTitle '>The Leading Real Estate Rental Marketplace.</h1>
                <p className='text-textColor font-medium text-[15px] '>Over 39,000 people work for us in more than 70 countries all over the This breadth of global coverage, combined with specialist services</p>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                    <div className='flex gap-5 items-center'>
                        <FaHouseLaptop className='bg-titleBg text-btn-primary p-[10px] text-[50px] rounded-full'/>
                        <p className='text-textColor text-[15px] '>Smart Home Design</p>
                    </div>
                    <div className='flex gap-5 items-center'>
                        <FaHouseLaptop className='bg-titleBg text-btn-primary p-[10px] text-[50px] rounded-full'/>
                        <p className='text-textColor text-[15px] '>Smart Home Design</p>
