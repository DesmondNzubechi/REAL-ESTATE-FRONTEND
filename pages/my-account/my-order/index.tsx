                                ...
                                <tbody className="w-full overflow-x-auto">
                                    <tr className="border-b">
                                        <td className="py-2 px-4">
                                            <Image src={myPic} className="w-[50px] h-[50px]" alt="Product Image" />
                                        </td>
                                        <td className="py-2 px-4 text-[10px] lg:text-[13px] font-bold text-textTilte uppercase">
                                            The new land
                                        </td>
                                        <td className="py-2 text-[10px] lg:text-[13px] px-4 text-textColor font-semibold">
                                            Aug, 10, 2024
                                        </td>
                                        <td className="py-2 w-ful px-4 self-center text-textColor font-semibold flex items-center">
                                            ...
                                            <Link href='/my-account/my-order/:id' className="bg-green-500 text-light min-w-[80px] p-1 text-[13px] rounded font-semibold">
                                                View Order
                                            </Link>
                                        </div>
                                        </td>
