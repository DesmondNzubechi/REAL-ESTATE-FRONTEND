...
export default function PropertyDetails() {
    ...
    <div className="px-[30px] py-[100px]">
        <div className="grid gap-[50px] grid-cols-7 lg:grid-cols-4">
            <MyAccountNav />
            <div></div>
                <div className="col-span-5 lg:col-span-3 flex flex-col px-[20px] gap-5 h-fit py-[30px]">
       ...
       <div className="  py-[20px] grid grid-cols-1 ">
            ...
            <div className="grid gap-[100px] grid-cols-1 pt-[50px] ">
                ...
                <span className="flex items-center gap-1"><FaLocationDot className="text-btn-primary text-[15px] md:text-[20px] lg:text-[20px]" /> <p className="font-medium capitalize text-[15px] text-textColor">Enugu, Nigeria</p></span>
