            ...
            <Link href='/blog/:slug' className="border ">
                ...
                <div className="flex flex-col py-[20px] px-[30px]  gap-5 ">
                    <div className="flex flex-row gap-5 items-center">
                        <span className="flex items-center gap-1"><p className="font-medium uppercase bg-btn-primary py-[10px] px-[20px] text-light">real estate</p></span>
</div>
                ...
                <div className="flex gap-5 ">
                    ...
                    <span className="flex items-center gap-1"><FaRegComments className="text-btn-primary text-[15px] md:text-[20px] lg:text-[20px]" /> <p className="font-medium capitalize text-[15px] text-textColor">40 Comments</p></span>
